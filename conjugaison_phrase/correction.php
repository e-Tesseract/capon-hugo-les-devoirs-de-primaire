<?php
	...
	$question = $_POST['sujet'].' ______ '.$_POST['finDePhrase'];
	...
	$type_exercice = 'conjugaison_phrase';
            ...
            <tr>
                <td style="width:1000px;height:430px;background-image:url('../images/NO.jpg');background-repeat:no-repeat;">
                    <center>
                        ...
                        <h2><?php if (!$est_correct) echo "La bonne réponse était : " . $_POST['sujet'] . " <strong><u>$reponse_attendue</u></strong> " . $_POST['finDePhrase'] . "."; ?></h2>
                        <br />
